...
export default function VehiclesError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[50vh] text-center px-4">
      ...
      <h2 className="text-lg font-semibold text-text-primary mb-1">Unable to load vehicles</h2>
      <p className="text-sm text-text-secondary mb-6 max-w-md">
        {error.message || "Something went wrong while loading vehicle data. Please try again."}
      </p>
      <button
        onClick={reset}
